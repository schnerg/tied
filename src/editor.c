...
void write_line_buffer_to_line( Editor * e )
{
	...
	memcpy( e->lines.list_of_lienes[e->cursor.y_index]->data, e->line_buff->contents, e->line_buff->count );
	e->lines.list_of_lienes[e->cursor.y_index]->count = e->line_buff->count;
	return;
}
